...
$(document).ready(function() {
    ...
    $('#logout a').click(function(e) {
        ...
        // ask verification
        $.SmartMessageBox({
            title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> Deseja realmente sair <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
            content: $.logoutMSG || "Você pode melhorar sua segurança fechando o navegador após realizar o logout (mas é apenas uma sugestão ;) ).",
            buttons: '[Não][Sim]'
