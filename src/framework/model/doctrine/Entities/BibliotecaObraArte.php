...
/**
 * @Entity 
 * @Table(name="biblioteca_obra_arte")
 */
class BibliotecaObraArte {
    /** 
    ...
    **/
    protected $titulo;
    /** 
    * @Column(name="nome_artista", type="string", length=150, nullable=TRUE ,unique=FALSE, columnDefinition="Nome do artista")
    **/
    protected $nomeArtista;
    /** 
    * @Column(name="estilo_arte", type="string", length=150, nullable=TRUE ,unique=FALSE, columnDefinition="Estilo da arte")
    **/
    protected $estiloArte;
    /** 
    ...
    **/
    ...
    public function setNomeArtista($nomeArtista) {
        $this->nomeArtista = $nomeArtista;
    }

    public function getEstiloArte() {
        return $this->estiloArte;
    }
    public function setEstiloArte($estiloArte) {
    ...
    public function toArray() {
        return BibliotecaObraArteAction::toArray($this);
    }
}
