<div class="row">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form class="smart-form" action="<?= URL_APP ?><?=$this->module?>/BibliotecaImagem/admFilter" id="frm" method="GET" autocomplete="off">
                        <fieldset>
                        <div class="row">
                        ...
                        <footer>
                            ...
                            <a class="btn btn-info" href="<?= URL_APP ?><?=$this->module?>/BibliotecaImagem/form"><i class="fa fa-file"></i> Novo</a>
                            <a data-toggle="modal" class="btn btn-danger" href="#deleteMultipleActionModal" onclick="eqDeleteSelecionadosForm('resultados', 'BibliotecaImagem.delSelected')" title="Clique aqui para excluir o(s) registro(s) selecionado(s)"><i class="fa fa-trash-o-o"></i> Excluir Selecionados</a>
                        </footer>
                    </form>
                </div>
            </div>
    ...
    <? include 'BibliotecaImagem.adm.php'; ?>
</div>
