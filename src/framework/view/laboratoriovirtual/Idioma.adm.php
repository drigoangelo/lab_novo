    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            <header>
                ...
                <div class="widget-toolbar" role="menu">
                    <a class="btn btn-info btn-xs" rel="tooltip" data-placement="top" title="Baixar PDF" target="_BLANK" href="<?php echo  URL_APP ?><?=$this->module?>/Idioma/relPDF?<?php echo  $allFiltersRel ?>">
                        <span class="fa fa fa-file-pdf-o"></span>
                    </a>
					<a class="btn btn-info btn-xs" rel="tooltip" data-placement="top" title="Baixar tudo HTML" target="_BLANK" href="<?php echo URL_APP ?><?= $this->module ?>/Idioma/relPdf?porPagina=T">
...
<th><a href="?order=sigla<?= $allFilters ?>">Sigla</a></th>
<th><a href="?order=padrao<?= $allFilters ?>">Idioma Padrão</a></th>
                            ...
                            <tbody>
                                <? foreach ($objects as $o) { ?>
                                    <tr>
                                        ...
                                        <td><?=$o->getTitulo()?></td>
<td><?=$o->getSigla()?></td>
<td><?= IdiomaAction::getValueForPadrao($o->getPadrao()); ?></td>
                                        <td class="edicao">
                                            <a href="<?php echo  URL_APP ?><?=$this->module?>/Idioma/edit/<?php echo  $o->getId() ?>" class="btn btn-default btn-small">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </td>
                                        <td class="delecao">
                                            <a data-toggle="modal" href="#deleteActionModal" onclick="IdiomaDeleteHandler('Idioma.del&id=<?php echo  $o->getId() ?>');" class="btn btn-danger btn-small">
