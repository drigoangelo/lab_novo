<?php
class BibliotecaImagemControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oBibliotecaImagemAction->validate($this->request);
            $oBibliotecaImagem = $oBibliotecaImagemAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oBibliotecaImagemAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oBibliotecaImagemAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "BibliotecaImagem");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oBibliotecaImagemAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(BibliotecaImagemAction::getModuleName(), "BibliotecaImagem","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(BibliotecaImagemAction::getModuleName(), "BibliotecaImagem","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oBibliotecaImagemAction = new BibliotecaImagemAction();
            $oBibliotecaImagemAction->validate($this->request,true);
            $oBibliotecaImagem = $oBibliotecaImagemAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oBibliotecaImagemAction = new BibliotecaImagemAction();
            $oBibliotecaImagemAction->validateDel($id);
            $oBibliotecaImagemAction->delPhysical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oBibliotecaImagemAction->validateDel($ids, false);
            $oBibliotecaImagemAction->delPhysicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(BibliotecaImagemAction::getModuleName().'/BibliotecaImagem.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = BibliotecaImagemAction::getFieldsStructure();
		$aFieldsTypeGenial = BibliotecaImagemAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "BibliotecaImagem", "BibliotecaImagemAction");

        return new View(null, $this->response, 'specificHeader');
    }

    public function suggest($conditions = array(), $order = 'tipo') {
        $oUtilAuth = new UtilAuth();
        ...
        $oBibliotecaImagemAction = new BibliotecaImagemAction();
        if ($idValue) {
            $objects = ($o = $oBibliotecaImagemAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.tipo LIKE '%{$descValue}%' ";
            }
            $objects = $oBibliotecaImagemAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oBibliotecaImagemAction,$objects, $page, 'getId'), $this->response, 'print');
    }
