<?php
class LaboratorioControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        if($this->auth() === FALSE)
            return $this->view;
        try {
            $oLaboratorioAction = new LaboratorioAction();
            $oLaboratorioAction->validate($this->request);
            $oLaboratorio = $oLaboratorioAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oLaboratorioAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oLaboratorioAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "Laboratorio");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oLaboratorioAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(LaboratorioAction::getModuleName(), "Laboratorio","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(LaboratorioAction::getModuleName(), "Laboratorio","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        $o = $oLaboratorioAction->select($id);
        if ($o === null){
        ...
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oLaboratorioAction = new LaboratorioAction();
            $oLaboratorioAction->validate($this->request,true);
            $oLaboratorio = $oLaboratorioAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oLaboratorioAction = new LaboratorioAction();
            $oLaboratorioAction->validateDel($id);
            $oLaboratorioAction->delLogical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oLaboratorioAction->validateDel($ids, false);
            $oLaboratorioAction->delLogicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(LaboratorioAction::getModuleName().'/Laboratorio.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = LaboratorioAction::getFieldsStructure();
		$aFieldsTypeGenial = LaboratorioAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "Laboratorio", "LaboratorioAction");
    ...
    public function suggest($conditions = array(), $order = 'titulo') {
        ...
        $oLaboratorioAction = new LaboratorioAction();
        if ($idValue) {
            $objects = ($o = $oLaboratorioAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.titulo LIKE '%{$descValue}%' ";
            }
            $objects = $oLaboratorioAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oLaboratorioAction,$objects, $page, 'getId'), $this->response, 'print');
    }
