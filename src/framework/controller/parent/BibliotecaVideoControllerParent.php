<?php
class BibliotecaVideoControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oBibliotecaVideoAction->validate($this->request);
            $oBibliotecaVideo = $oBibliotecaVideoAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oBibliotecaVideoAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oBibliotecaVideoAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "BibliotecaVideo");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oBibliotecaVideoAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(BibliotecaVideoAction::getModuleName(), "BibliotecaVideo","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(BibliotecaVideoAction::getModuleName(), "BibliotecaVideo","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oBibliotecaVideoAction = new BibliotecaVideoAction();
            $oBibliotecaVideoAction->validate($this->request,true);
            $oBibliotecaVideo = $oBibliotecaVideoAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oBibliotecaVideoAction = new BibliotecaVideoAction();
            $oBibliotecaVideoAction->validateDel($id);
            $oBibliotecaVideoAction->delPhysical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oBibliotecaVideoAction->validateDel($ids, false);
            $oBibliotecaVideoAction->delPhysicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(BibliotecaVideoAction::getModuleName().'/BibliotecaVideo.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = BibliotecaVideoAction::getFieldsStructure();
		$aFieldsTypeGenial = BibliotecaVideoAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "BibliotecaVideo", "BibliotecaVideoAction");
    ...
    public function suggest($conditions = array(), $order = 'titulo') {
        ...
        $oBibliotecaVideoAction = new BibliotecaVideoAction();
        if ($idValue) {
            $objects = ($o = $oBibliotecaVideoAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.titulo LIKE '%{$descValue}%' ";
            }
            $objects = $oBibliotecaVideoAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oBibliotecaVideoAction,$objects, $page, 'getId'), $this->response, 'print');
    }
