<?php
class BibliotecaObraArteControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oBibliotecaObraArteAction->validate($this->request);
            $oBibliotecaObraArte = $oBibliotecaObraArteAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oBibliotecaObraArteAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oBibliotecaObraArteAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "BibliotecaObraArte");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oBibliotecaObraArteAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(BibliotecaObraArteAction::getModuleName(), "BibliotecaObraArte","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(BibliotecaObraArteAction::getModuleName(), "BibliotecaObraArte","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oBibliotecaObraArteAction = new BibliotecaObraArteAction();
            $oBibliotecaObraArteAction->validate($this->request,true);
            $oBibliotecaObraArte = $oBibliotecaObraArteAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oBibliotecaObraArteAction = new BibliotecaObraArteAction();
            $oBibliotecaObraArteAction->validateDel($id);
            $oBibliotecaObraArteAction->delPhysical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oBibliotecaObraArteAction->validateDel($ids, false);
            $oBibliotecaObraArteAction->delPhysicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(BibliotecaObraArteAction::getModuleName().'/BibliotecaObraArte.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = BibliotecaObraArteAction::getFieldsStructure();
		$aFieldsTypeGenial = BibliotecaObraArteAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "BibliotecaObraArte", "BibliotecaObraArteAction");
    ...
    public function suggest($conditions = array(), $order = 'titulo') {
        ...
        $oBibliotecaObraArteAction = new BibliotecaObraArteAction();
        if ($idValue) {
            $objects = ($o = $oBibliotecaObraArteAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.titulo LIKE '%{$descValue}%' ";
            }
            $objects = $oBibliotecaObraArteAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oBibliotecaObraArteAction,$objects, $page, 'getId'), $this->response, 'print');
    }
