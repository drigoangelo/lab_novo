...
var Webcam = {
	...
	init: function() {
		...
		window.__URL__ = window.__URL__ || window.webkitURL || window.mozURL || window.msURL;
		
		this.userMedia = this.userMedia && !!navigator.getUserMedia && !!window.__URL__;
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			function(stream) {
				...
				video.src = window.__URL__.createObjectURL( stream ) || stream;
