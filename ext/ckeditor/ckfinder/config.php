<?php
define("IGENIAL_ROOT_DIR_FOR_CKFINDER", dirname(__FILE__) .  "/../../.."); #usei sem a barra pra manter o padrao desta constante
define("IGENIAL_ROOT_DIR", IGENIAL_ROOT_DIR_FOR_CKFINDER); 
require IGENIAL_ROOT_DIR_FOR_CKFINDER . "/framework/controller/FrontController.php";
$oConfig = new Config();
/*
...
function CheckAuthentication()
{
    ...
    return $oUtilAuth->usuarioAutenticado(null, true);
}
...
*/
$uploadDir = "ckfinder/userfiles/";
$baseUrl = URL . "upload/{$uploadDir}";
...
ATTENTION: The trailing slash is required.
*/
$baseDir = IGENIAL_ROOT_DIR_FOR_CKFINDER . "/upload/{$uploadDir}" ;
