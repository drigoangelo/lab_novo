...
define("IGENIAL_ROOT_DIR", realpath(dirname(__FILE__) . "/../../../")); # index.php - geral
# includes e instancias IGENIAL
include_once(IGENIAL_ROOT_DIR . "/bib/classes/util/i18n/Language.php");
include_once(IGENIAL_ROOT_DIR . "/bib/classes/settings/ConstantsConfig.php");
include_once(IGENIAL_ROOT_DIR . "/bib/classes/settings/Config.php");
include_once(IGENIAL_ROOT_DIR . "/bib/classes/settings/Constants.php");
include_once(IGENIAL_ROOT_DIR . "/bib/classes/util/UtilParent.php");
include_once(IGENIAL_ROOT_DIR . "/bib/classes/util/UtilAuthParent.php");
include_once(IGENIAL_ROOT_DIR . "/framework/bib/util/Util.php");
include_once(IGENIAL_ROOT_DIR . "/framework/bib/util/UtilAuth.php");
include_once(IGENIAL_ROOT_DIR . "/framework/controller/FrontController.php"); # para classes genial
$oConstantesConfiguracao = new Config(); // só pra ter as classes e constantes
// validação do do login do usuário
$oUsuario = Util::object_to_array(Util::convert2stdClass(unserialize($_SESSION['serUsuarioSessao'])));
$id_usuario = $oUsuario["id"];
if (!$oUsuario || !$id_usuario) {
    exit("VocÊ precisa estar logado para acessar esta área!");
}
...
$config = array(
    ...
    /*
      ...
      |
     */
    'upload_dir' => 'upload/filemanager/uploads/',
    /*
      |--------------------------------------------------------------------------
      ...
      |
     */
    'current_path' => '../../upload/filemanager/uploads/',
    /*
      |--------------------------------------------------------------------------
    ...
    'previewable_text_file_exts_no_prettify' => array('txt'),
