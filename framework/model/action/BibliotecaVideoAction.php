<?php
include_once(dirname(__FILE__).'/../actionparent/BibliotecaVideoActionParent.php');

class BibliotecaVideoAction extends BibliotecaVideoActionParent {
    ...
    public function editTransaction($oBibliotecaVideo, $request){
