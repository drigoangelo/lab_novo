        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form class="smart-form" method="post" action="<?= URL ?>index.php?action=Laboratorio.formSubmit" id="frm" name="frm" onsubmit="return false;" autocomplete="off" enctype='multipart/form-data' >
                        <header>
                            Geral
                        </header>
                        <fieldset>
                        ...
                        <section>
                            <label class="label" for="termoUso">Termo de Uso</label>
                                <label class="input">
                                    <textarea class="ckeditor" id="termoUso" name="termoUso" tabindex='<?=(++$tabindex)?>'></textarea>
                                </label>
                        </section>
                        ...
                        <footer>
                            <button class="btn btn-primary" onclick="LaboratorioSubmitHandler(this, false);" tabindex="<?= ++$tabindex ?>" ><i class="icon-check icon-white"></i> Salvar</button>
                            <button class="btn btn-primary" onclick="LaboratorioSubmitHandler(this, true);" tabindex="<?= ++$tabindex ?>" ><i class="icon-share icon-white"></i> Salvar e Sair</button>
