<div class="row">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form class="smart-form" action="<?= URL_APP ?><?= $this->module ?>/Relatorio/relQuantidadeAcessoUsuarioAdmFilter" id="frm" method="GET" autocomplete="off">
                        <fieldset>
                            <div class="row">
    ...
    <? include 'Relatorio.relQuantidadeAcessoUsuarioAdm.php' ?>
</div>
