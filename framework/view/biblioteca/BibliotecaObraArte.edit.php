        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form class="smart-form" method="post" action="<?= URL ?>index.php?action=BibliotecaObraArte.editSubmit" id="frm" name="frm" onsubmit="return false;" autocomplete="off" enctype='multipart/form-data' >
                        <header>
                            Geral
                        </header>
                        <fieldset>
                        ...
                        <section>
                            <label class="label" for="nomeArtista">Nome do artista</label>
                                <label class="input">
                                    <input class="form-control"  type="text" id="nomeArtista" name="nomeArtista" maxlength='150' mask='' tabindex='<?=(++$tabindex)?>' value='<?=($o->getNomeArtista())?>'/>
                                </label>
                        </section>
                        ...
                        <section>
                            <label class="label" for="estiloArte">Estilo da arte</label>
                                <label class="input">
                                    <input class="form-control"  type="text" id="estiloArte" name="estiloArte" maxlength='150' mask='' tabindex='<?=(++$tabindex)?>' value='<?=($o->getEstiloArte())?>'/>
                                </label>
                        </section>
                        ...
                        <section>
                            ...
                            <div class="note">
                                <strong>Arquivo atual:</strong> <a href="<?php echo URL_APP ?><?= $this->module ?>/BibliotecaObraArte/edit/<?php echo $o->getId() ?>?isDownload=1" target="_blank"><?php echo htmlentities($o->getArquivoName())?></a>
                            </div>
                        </section>
                        ...
                        <footer>
                            <button class="btn btn-primary" onclick="BibliotecaObraArteEditHandler(this, false);" tabindex="<?= ++$tabindex ?>" ><i class="icon-check icon-white"></i> Salvar</button>
                            <button class="btn btn-primary" onclick="BibliotecaObraArteEditHandler(this, true);" tabindex="<?= ++$tabindex ?>" ><i class="icon-share icon-white"></i> Salvar e Sair</button>
                            <button class="btn btn-warning" type="reset" tabindex="<?= ++$tabindex ?>" ><i class="icon-remove-circle icon-white"></i> Limpar</button>
                            <a href="<?= URL_APP ?><?=$this->module?>/BibliotecaObraArte/admFilter" tabindex="<?= ++$tabindex ?>" class="btn btn-danger"><i class="icon-share-alt icon-white"></i> Sair</a>
                        </footer>
                    </form>
                </div>
            </div>
