    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            <header>
                ...
                <div class="widget-toolbar" role="menu">
                    <a class="btn btn-info btn-xs" rel="tooltip" data-placement="top" title="Baixar PDF" target="_BLANK" href="<?php echo  URL_APP ?><?=$this->module?>/BibliotecaVideo/relPDF?<?php echo  $allFiltersRel ?>">
                        <span class="fa fa fa-file-pdf-o"></span>
                    </a>
					<a class="btn btn-info btn-xs" rel="tooltip" data-placement="top" title="Baixar tudo HTML" target="_BLANK" href="<?php echo URL_APP ?><?= $this->module ?>/BibliotecaVideo/relPdf?porPagina=T">
                            ...
                            <tbody>
                                <? foreach ($objects as $o) { ?>
                                    <tr>
                                        ...
                                        <td class="edicao">
                                            <a href="<?php echo  URL_APP ?><?=$this->module?>/BibliotecaVideo/edit/<?php echo  $o->getId() ?>" class="btn btn-default btn-small">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </td>
                                        <td class="delecao">
                                            <a data-toggle="modal" href="#deleteActionModal" onclick="BibliotecaVideoDeleteHandler('BibliotecaVideo.del&id=<?php echo  $o->getId() ?>');" class="btn btn-danger btn-small">
