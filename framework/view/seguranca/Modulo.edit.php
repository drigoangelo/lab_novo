        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form class="smart-form" method="post" action="<?= URL ?>index.php?action=Modulo.editSubmit" id="frm" name="frm" onsubmit="return false;" autocomplete="off" enctype='multipart/form-data' >
                        <header>
                            Geral
                        </header>
                        <fieldset>
                        ...
                        <section>
                            <label class="label"for="Entidade"><?=CAMPO_OBRIGATORIO?> Entidade</label>
                                <label class="input">
                                    <suggest id='Entidade' entity='Entidade' hasComboBox='true' tabindex='<?=(++$tabindex)?>' value='<?=($o->getEntidade()->getId())?>' />
                                </label>
                        </section>
                        ...
                        <footer>
                            <button class="btn btn-primary" onclick="ModuloEditHandler(this, false);" tabindex="<?= ++$tabindex ?>" ><i class="icon-check icon-white"></i> Salvar</button>
                            <button class="btn btn-primary" onclick="ModuloEditHandler(this, true);" tabindex="<?= ++$tabindex ?>" ><i class="icon-share icon-white"></i> Salvar e Sair</button>
