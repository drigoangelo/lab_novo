<?php
class ConteudoControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(ConteudoAction::getModuleName().'/Conteudo.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oConteudoAction->validate($this->request);
            $oConteudo = $oConteudoAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(ConteudoAction::getModuleName().'/Conteudo.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oConteudoAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oConteudoAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "Conteudo");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oConteudoAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(ConteudoAction::getModuleName(), "Conteudo","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(ConteudoAction::getModuleName(), "Conteudo","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(ConteudoAction::getModuleName().'/Conteudo.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(ConteudoAction::getModuleName().'/Conteudo.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(ConteudoAction::getModuleName().'/Conteudo.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oConteudoAction = new ConteudoAction();
            $oConteudoAction->validate($this->request,true);
            $oConteudo = $oConteudoAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oConteudoAction = new ConteudoAction();
            $oConteudoAction->validateDel($id);
            $oConteudoAction->delLogical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oConteudoAction->validateDel($ids, false);
            $oConteudoAction->delLogicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(ConteudoAction::getModuleName().'/Conteudo.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = ConteudoAction::getFieldsStructure();
		$aFieldsTypeGenial = ConteudoAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "Conteudo", "ConteudoAction");
    ...
    public function suggest($conditions = array(), $order = 'titulo') {
        ...
        $oConteudoAction = new ConteudoAction();
        if ($idValue) {
            $objects = ($o = $oConteudoAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.titulo LIKE '%{$descValue}%' ";
            }
            $objects = $oConteudoAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oConteudoAction,$objects, $page, 'getId'), $this->response, 'print');
    }
