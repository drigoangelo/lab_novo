...
class AcaoControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(AcaoAction::getModuleName().'/Acao.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oAcaoAction->validate($this->request);
            $oAcao = $oAcaoAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(AcaoAction::getModuleName().'/Acao.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oAcaoAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oAcaoAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "Acao");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oAcaoAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(AcaoAction::getModuleName(), "Acao","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(AcaoAction::getModuleName(), "Acao","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(AcaoAction::getModuleName().'/Acao.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(AcaoAction::getModuleName().'/Acao.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(AcaoAction::getModuleName().'/Acao.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oAcaoAction = new AcaoAction();
            $oAcaoAction->validate($this->request,true);
            $oAcao = $oAcaoAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oAcaoAction = new AcaoAction();
            $oAcaoAction->validateDel($id);
            $oAcaoAction->delLogical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oAcaoAction->validateDel($ids, false);
            $oAcaoAction->delLogicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(AcaoAction::getModuleName().'/Acao.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = AcaoAction::getFieldsStructure();
		$aFieldsTypeGenial = AcaoAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "Acao", "AcaoAction");
    ...
    public function suggest($conditions = array(), $order = 'nome') {
        ...
        $oAcaoAction = new AcaoAction();
        if ($idValue) {
            $objects = ($o = $oAcaoAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.nome LIKE '%{$descValue}%' ";
            }
            $objects = $oAcaoAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oAcaoAction,$objects, $page, 'getId'), $this->response, 'print');
    }
