...
class IdiomaControllerParent {
    ...
    public function form(){
        if($this->auth() === FALSE)
            return $this->view;
        return new View(IdiomaAction::getModuleName().'/Idioma.form.php',$this->response, $this->viewMethod);
    }
    ...
    public function formSubmit(){
        ...
        try {
            ...
            $oIdiomaAction->validate($this->request);
            $oIdioma = $oIdiomaAction->add($this->request, true, true);
        } catch (Exception $ex) {
    ...
    public function admFilter() {
        if($this->auth() === FALSE)
            return $this->view;
        $this->adm();
        return new View(IdiomaAction::getModuleName().'/Idioma.admFilter.php',$this->response, $this->viewMethod);
    }
    ...
    public function adm() {
        ...
        $conditions = $oIdiomaAction->filterConditions($this->request, $this->response, $orderPageConditions);
        
        # paginacao
        $fields = $oIdiomaAction->getAdmFields();
        ...
        $resultsPerPage = ControllerUtil::porPagina($this->request, $this->response, "Idioma");
        
        $conditions = join(" AND ", $conditions);
        $objects = $oIdiomaAction->paginatedCollection($fields, ($page * $resultsPerPage), $resultsPerPage, $conditions, $orderSql, FALSE, $paginator);
        ...
        $this->response->set("paginationLinks", Paging::getPageLinks(IdiomaAction::getModuleName(), "Idioma","admFilter", $total, $this->gapPerPage, $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("perPageLinks", Paging::quantidadePorPagina(IdiomaAction::getModuleName(), "Idioma","admFilter", $page, "{$orderPageConditions}{$orderPageLinks}", $this->request->get("porPagina")));
        $this->response->set("currentPage", $page);
        return new View(IdiomaAction::getModuleName().'/Idioma.adm.php',$this->response, $this->viewMethod);
    }
    ...
    public function view() {
        ...
        return new View(IdiomaAction::getModuleName().'/Idioma.view.php',$this->response, $this->viewMethod);
    }
    ...
    public function edit() {
        ...
        $this->response->set("object",$o);
        return new View(IdiomaAction::getModuleName().'/Idioma.edit.php',$this->response, $this->viewMethod);
    }
    ...
    public function editSubmit(){
        ...
        try {
            $oIdiomaAction = new IdiomaAction();
            $oIdiomaAction->validate($this->request,true);
            $oIdioma = $oIdiomaAction->edit($this->request);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function del() {
        ...
        try {
            $id = (int) $this->request->get("id");
            $oIdiomaAction = new IdiomaAction();
            $oIdiomaAction->validateDel($id);
            $oIdiomaAction->delPhysical($id);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function delSelected() {
        ...
        try {
            ...
            $oIdiomaAction->validateDel($ids, false);
            $oIdiomaAction->delPhysicalSelected($ids);
        } catch (Exception $ex) {
            return new View(ExceptionHandler::getMessage($ex),$this->response,'print');
        }
        return new View('OK',$this->response,'print');
    ...
    public function relPDF(){
        ...
        $this->adm();
        return new View(IdiomaAction::getModuleName().'/Idioma.relPdf.php',$this->response, $method_view);
    }
    ...
    public function relXLS(){
        ...
        $aFieldsStructure = IdiomaAction::getFieldsStructure();
		$aFieldsTypeGenial = IdiomaAction::getFieldsTypeGenial();
        $aTableHeader = array();
        ...
        Util::relXls($objects, $aTableHeader, "Idioma", "IdiomaAction");
    ...
    public function suggest($conditions = array(), $order = 'titulo') {
        ...
        $oIdiomaAction = new IdiomaAction();
        if ($idValue) {
            $objects = ($o = $oIdiomaAction->select($idValue))? array($o) :false;
        } else {
            if ($descValue) {
                if(count($conditions) <= 0)
                    $conditions[] = "o.titulo LIKE '%{$descValue}%' ";
            }
            $objects = $oIdiomaAction->paginatedCollection(null, ($page * $limit), $limit, $conditions, $order);
        }        
        return new View( ControllerUtil::objectsToSuggest($oIdiomaAction,$objects, $page, 'getId'), $this->response, 'print');
    }
